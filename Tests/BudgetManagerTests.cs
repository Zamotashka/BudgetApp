...
namespace BudgetApp.Tests
{
    ...
    public class BudgetManagerTests
    {
        ...
        public void UpdateTransaction_ChangesDescription()
        {
            ...
            _manager.AddTransaction(transaction);
            // Act
            _manager.UpdateTransaction(transaction, "Новое", 1000, TransactionType.Доход, DateTime.Today, "Без категории");
            // Assert
        ...
        public void UpdateTransaction_ChangesAmount()
        {
            ...
            _manager.AddTransaction(transaction);
            // Act
            _manager.UpdateTransaction(transaction, "Зарплата", 5000, TransactionType.Доход, DateTime.Today, "Без категории");
            // Assert
        ...
        public void UpdateTransaction_ChangesType()
        {
            ...
            _manager.AddTransaction(transaction);
            // Act
            _manager.UpdateTransaction(transaction, "Перевод", 1000, TransactionType.Расход, DateTime.Today, "Без категории");
            // Assert
        ...
        {
            // Act
            _manager.UpdateTransaction(null, "Тест", 1000, TransactionType.Доход, DateTime.Today, "Без категории");
        }
    }
}